...
import { updateHousingPost } from "../../services/UpdateHousingPost";
...
const EditModal: React.FC<EditModalProps> = ({
  ...
  // Update the editedData state when the initialData prop changes
  useEffect(() => {
  ...
  const handleSave = async () => {
    try {
      ...
      await updateHousingPost(initialData._id, updatedData);
